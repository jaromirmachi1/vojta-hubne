...
import bundleImage from '../../assets/90dnispicusemnew.png'
import {
  ALT_SECTION_IDS,
...
export function MainOffer() {
  ...
  return (
    <AltSection id={ALT_SECTION_IDS.mainOffer}>
      <AltInner>
        <Reveal>
        ...
        <Reveal delay={0.08}>
          <OfferCard>
            ...
            <ImageWrap>
              <ProductImage
                src={bundleImage}
                alt="90 dní s Vojtou — Lean Shake, GLP-1 Support a Aquamin Mg"
                loading="lazy"
              />
            </ImageWrap>
          </OfferCard>
        ...
        <SecondaryScroll>
          <ScrollLink
            ...
            onClick={() =>
              document
                .getElementById(ALT_SECTION_IDS.comparison)
